...
public class C03S002_001Activity_ViewBinding<T extends C03S002_001Activity> implements Unbinder {
  protected T target;

  private View view2131558488;

  @UiThread
  public C03S002_001Activity_ViewBinding(final T target, View source) {
    this.target = target;
